...
{
protected:
    int32_t m_FirstSample;///<The first sample of an epoch (208)
    int32_t m_DataSkip;///<Number of blocks to skip before actual data starts (301)
    int32_t m_DataSkipSamples;///<Data skip in samples (303)
